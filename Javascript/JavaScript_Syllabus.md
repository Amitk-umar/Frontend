...
> 🛠️ **End-of-phase mini projects:** Calculator, temperature converter, FizzBuzz, simple guessing game.
...
> 🛠️ **End-of-phase mini projects:** To-do list (in-memory), student grade tracker, shopping cart logic, word frequency counter.
...
> 🛠️ **Capstone project ideas:** Weather app using Fetch API, expense tracker with localStorage, quiz app, simple Kanban board.
